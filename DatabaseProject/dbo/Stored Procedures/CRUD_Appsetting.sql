...
Begin		
		...
		Update ChannelSetting set Value=@OverlayObjectStyle Where Particular='OverlayObjectStyle' And ChnID=@ChnID				Update ChannelSetting set Value=@TickerProgramDisplay Where Particular='TickerProgramDisplay' And ChnID=@ChnID
